...
class QROfferAdmin(admin.ModelAdmin):
    list_display = ['title', 'qr_code_id', 'reveal_type', 'scan_count', 'max_scans', 'is_active', 'is_valid']
...
class QRScanLogAdmin(admin.ModelAdmin):
    list_display = ['qr_offer', 'discount_revealed', 'coupon_code', 'is_used', 'scanned_at', 'expires_at']
    list_filter = ['is_used']
