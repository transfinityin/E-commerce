...
const SHADOWWAR_PRODUCTS = [
  { id: 'shadow-war1', name: 'ShadowWar Tee', price: 1299, image: '/products/shadow-war-tee.jpg', description: 'Arc 11 exclusive. Limited edition.' },
  { id: 'shadow-war2', name: 'ShadowWar Hoodie', price: 2499, image: '/products/shadow-war-hoodie.jpg', description: 'Premium streetwear for the journey.' },
  { id: 'shadow-war3', name: 'ShadowWar Cap', price: 899, image: '/products/shadow-war-cap.jpg', description: 'Mark your path beyond limits.' },
  { id: 'shadow-war4', name: 'ShadowWar Poster', price: 599, image: '/products/shadow-war-poster.jpg', description: 'Visual reminder of the threshold.' },
]
  ...
  return (
    <section className="relative w-full h-[70vh] sm:h-[80vh] overflow-hidden">
      <div className="absolute inset-0 z-0">
        <video autoPlay muted loop playsInline className="w-full h-full object-cover" poster="/videos/shadow-war-poster.jpg">
          <source src="/videos/shadow-war-header.mp4" type="video/mp4" />
        </video>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full px-4 text-center">
        ...
        <div className="mb-6 animate-fade-in-up">
          <div className="inline-flex items-center gap-3 px-5 py-2 border border-gold/40 bg-black/40 backdrop-blur-sm">
            <div className="grid size-8 place-items-center border border-gold text-gold bg-gold/10 font-serif text-sm">11</div>
            <span className="font-mono text-[10px] uppercase tracking-[0.4em] text-gold">Arc Eleven</span>
          </div>
        </div>
        ...
        <h1 className="animate-fade-in-up font-serif text-5xl sm:text-6xl md:text-7xl lg:text-8xl uppercase leading-none tracking-[0.02em] text-white drop-shadow-[0_0_30px_rgba(0,0,0,0.9)]" style={{ animationDelay: '0.2s' }}>
          The <span className="normal-case italic text-gold text-shimmer">ShadowWar</span>
        </h1>
...
function AudioControls() {
  ...
  React.useEffect(() => {
    audioRef.current = new Audio('/audio/shadow-war-ambient.mp3')
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-10">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <h2 className="font-serif text-2xl sm:text-3xl md:text-4xl uppercase tracking-[0.08em] text-white/90">
            The Eternal <span className="italic text-gold">Light</span>
          </h2>
        </div>

        <div className="space-y-8">
          <div className="animate-fade-in-up border-l-2 border-gold/30 pl-6 sm:pl-8" style={{ animationDelay: '0.0s' }}>
            <p className="text-sm sm:text-base leading-[1.9] text-white/70 font-light">As the Shadow War pushed humanity to the edge of extinction, the skies above the world suddenly changed. The cosmic darkness that once consumed the heavens began splitting apart, revealing an endless ocean of white-and-gold light descending from beyond the Infinite Dimension. In that moment, Kairos finally understood the true nature of infinity: darkness and light were never enemies — they were two halves of evolution itself. This revelation marked the beginning of the Celestial Arc — "The Eternal Light." Across the planet, the remaining Founders awakened a new form of power fueled not by rage or fear, but by clarity, unity, and purpose. For the first time since the Awakening, humanity stopped fighting itself and stood together beneath the celestial skies.</p>
          </div>
          <div className="animate-fade-in-up border-l-2 border-white/10 pl-6 sm:pl-8" style={{ animationDelay: '0.15s' }}>
            <p className="text-sm sm:text-base leading-[1.9] text-white/70 font-light">At the center of the Infinite Dimension, Kairos confronted the ancient cosmic force that had manipulated reality since the beginning of existence. But instead of destroying it, he chose to merge with it, accepting both darkness and light within himself to prevent reality from collapsing forever. The fusion unleashed a massive wave of celestial energy across the universe, healing fractured dimensions and ending the Shadow War instantly. Around the world, people witnessed the infinity symbol illuminate the sky one final time before transforming into a radiant eternal emblem visible across the stars. When the light faded, Kairos had disappeared without a trace once again. But unlike before, the world no longer feared his absence — because humanity had finally evolved beyond its limits, carrying the spirit of TRANSFINITY within them forever.</p>
          </div>
          ...
          <div className="animate-fade-in-up my-10 sm:my-12 py-8 px-6 sm:px-8 border border-gold/20 bg-gold/[0.03] text-center" style={{ animationDelay: '0.3s' }}>
            <div className="font-serif text-xl sm:text-2xl md:text-3xl italic text-gold/80 leading-relaxed">
              Darkness and light are not enemies. They are the two halves of infinity.
            </div>
          </div>
        </div>
    ...
    <section className="relative z-10 py-16 sm:py-20 lg:py-24 pb-24 sm:pb-32">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-10">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <h2 className="font-serif text-2xl sm:text-3xl md:text-4xl uppercase tracking-[0.08em] text-white/90">
            ShadowWar <span className="italic text-gold">Essentials</span>
          </h2>
          <p className="mt-4 text-sm text-white/50 max-w-lg mx-auto">
            Light and darkness united. The balance of infinity.
          </p>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          {SHADOWWAR_PRODUCTS.map((product, index) => (
        ...
        <div className="text-center mt-12 sm:mt-16 flex flex-wrap items-center justify-center gap-4">
          ...
          <Link to="/arcs/cosmic" className="inline-flex items-center gap-2 px-6 py-3 border border-white/10 text-white/50 font-mono text-[10px] uppercase tracking-[0.3em] hover:border-gold/40 hover:text-gold transition-all duration-300">
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" /></svg>
            Previous Arc
          </Link>
          <Link to="/arcs/celestial" className="inline-flex items-center gap-2 px-6 py-3 border border-gold/40 text-gold font-mono text-[10px] uppercase tracking-[0.3em] hover:bg-gold/10 transition-all duration-300">
            Next Arc
    ...
    <div className="group relative border border-white/10 bg-black/40 backdrop-blur-sm overflow-hidden transition-all duration-500 hover:border-gold/40 hover:bg-black/60 hover:-translate-y-2" style={{ animationDelay: `${index*0.1}s` }}>
      ...
      <div className="p-4 sm:p-5">
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="font-mono text-[10px] uppercase tracking-wider text-white/30">Arc 11</span>
        </div>
      </div>
    </div>
  )
