...
const FOUNDERER_PRODUCTS = [
  { id: 'founderer1', name: 'Founderer Tee', price: 1299, image: '/products/founderer-tee.jpg', description: 'Arc 02 exclusive. Limited edition.' },
  { id: 'founderer2', name: 'Founderer Hoodie', price: 2499, image: '/products/founderer-hoodie.jpg', description: 'Premium streetwear for the journey.' },
  { id: 'founderer3', name: 'Founderer Cap', price: 899, image: '/products/founderer-cap.jpg', description: 'Mark your path beyond limits.' },
  { id: 'founderer4', name: 'Founderer Poster', price: 599, image: '/products/founderer-poster.jpg', description: 'Visual reminder of the threshold.' },
]

export default function Founderer() {
  return (
    <>
      <style>{`
        @keyframes fadeInUp {
  ...
  return (
    <section className="relative w-full h-[70vh] sm:h-[80vh] overflow-hidden">
      <div className="absolute inset-0 z-0">
        <video autoPlay muted loop playsInline className="w-full h-full object-cover" poster="/videos/founderer-poster.jpg">
          <source src="/videos/founderer-header.mp4" type="video/mp4" />
        </video>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full px-4 text-center">
        ...
        <div className="mb-6 animate-fade-in-up">
          <div className="inline-flex items-center gap-3 px-5 py-2 border border-gold/40 bg-black/40 backdrop-blur-sm">
            <div className="grid size-8 place-items-center border border-gold text-gold bg-gold/10 font-serif text-sm">02</div>
            <span className="font-mono text-[10px] uppercase tracking-[0.4em] text-gold">Arc Two</span>
          </div>
        </div>
        ...
        <h1 className="animate-fade-in-up font-serif text-5xl sm:text-6xl md:text-7xl lg:text-8xl uppercase leading-none tracking-[0.02em] text-white drop-shadow-[0_0_30px_rgba(0,0,0,0.9)]" style={{ animationDelay: '0.2s' }}>
          The <span className="normal-case italic text-gold text-shimmer">Founderer</span>
        </h1>
...
function AudioControls() {
  ...
  React.useEffect(() => {
    audioRef.current = new Audio('/audio/founderer-ambient.mp3')
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-10">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <h2 className="font-serif text-2xl sm:text-3xl md:text-4xl uppercase tracking-[0.08em] text-white/90">
            Building the <span className="italic text-gold">Foundation</span>
          </h2>
        </div>

        <div className="space-y-8">
          <div className="animate-fade-in-up border-l-2 border-gold/30 pl-6 sm:pl-8" style={{ animationDelay: '0.0s' }}>
            <p className="text-sm sm:text-base leading-[1.9] text-white/70 font-light">After the sudden rise of TRANSFINITY, the city became obsessed with finding the creator behind the infinity symbol. People began spotting the mark ♾ across abandoned tunnels, digital billboards, rooftops, and underground streets, but the Founder himself had vanished without explanation. Rumors spread everywhere. Some believed he had been captured by "The Frame." Others believed he never truly existed. As fear and curiosity grew, mysterious figures wearing black hoodies marked with the infinity emblem started appearing throughout the city. They moved silently through the shadows, spreading the symbol like a hidden message meant only for those ready to awaken.</p>
          </div>
          <div className="animate-fade-in-up border-l-2 border-white/10 pl-6 sm:pl-8" style={{ animationDelay: '0.15s' }}>
            <p className="text-sm sm:text-base leading-[1.9] text-white/70 font-light">This period became known as the Phantom Arc — "The Disappearance." During this arc, TRANSFINITY transformed from a secret idea into an underground movement. The absence of the Founder made the symbol even more powerful, turning Kairos into a myth rather than a man. People no longer followed a person — they followed a belief. Hidden communities formed in silence, united by one purpose: escaping the limits forced upon humanity. And somewhere deep within the darkness of the city, Kairos watched everything unfold from the shadows, preparing for the next stage of evolution.</p>
          </div>
          ...
          <div className="animate-fade-in-up my-10 sm:my-12 py-8 px-6 sm:px-8 border border-gold/20 bg-gold/[0.03] text-center" style={{ animationDelay: '0.3s' }}>
            <div className="font-serif text-xl sm:text-2xl md:text-3xl italic text-gold/80 leading-relaxed">
              To build is to believe the future is worth inhabiting.
            </div>
          </div>
        </div>
    ...
    <section className="relative z-10 py-16 sm:py-20 lg:py-24 pb-24 sm:pb-32">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-10">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <h2 className="font-serif text-2xl sm:text-3xl md:text-4xl uppercase tracking-[0.08em] text-white/90">
            Founderer <span className="italic text-gold">Essentials</span>
          </h2>
          <p className="mt-4 text-sm text-white/50 max-w-lg mx-auto">
            Wear the mark of the architect. Each piece represents the foundation of something greater.
          </p>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          {FOUNDERER_PRODUCTS.map((product, index) => (
        ...
        <div className="text-center mt-12 sm:mt-16 flex flex-wrap items-center justify-center gap-4">
          ...
          <Link to="/arcs/wanderer" className="inline-flex items-center gap-2 px-6 py-3 border border-white/10 text-white/50 font-mono text-[10px] uppercase tracking-[0.3em] hover:border-gold/40 hover:text-gold transition-all duration-300">
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" /></svg>
            Previous Arc
          </Link>
          <Link to="/arcs/phantom" className="inline-flex items-center gap-2 px-6 py-3 border border-gold/40 text-gold font-mono text-[10px] uppercase tracking-[0.3em] hover:bg-gold/10 transition-all duration-300">
            Next Arc
    ...
    <div className="group relative border border-white/10 bg-black/40 backdrop-blur-sm overflow-hidden transition-all duration-500 hover:border-gold/40 hover:bg-black/60 hover:-translate-y-2" style={{ animationDelay: `${index*0.1}s` }}>
      ...
      <div className="p-4 sm:p-5">
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="font-mono text-[10px] uppercase tracking-wider text-white/30">Arc 02</span>
        </div>
      </div>
    </div>
  )
