...
const ASCENSION_PRODUCTS = [
  { id: 'ascension1', name: 'Ascension Tee', price: 1299, image: '/products/ascension-tee.jpg', description: 'Arc 04 exclusive. Limited edition.' },
  { id: 'ascension2', name: 'Ascension Hoodie', price: 2499, image: '/products/ascension-hoodie.jpg', description: 'Premium streetwear for the journey.' },
  { id: 'ascension3', name: 'Ascension Cap', price: 899, image: '/products/ascension-cap.jpg', description: 'Mark your path beyond limits.' },
  { id: 'ascension4', name: 'Ascension Poster', price: 599, image: '/products/ascension-poster.jpg', description: 'Visual reminder of the threshold.' },
]
  ...
  return (
    <section className="relative w-full h-[70vh] sm:h-[80vh] overflow-hidden">
      <div className="absolute inset-0 z-0">
        <video autoPlay muted loop playsInline className="w-full h-full object-cover" poster="/videos/ascension-poster.jpg">
          <source src="/videos/ascension-header.mp4" type="video/mp4" />
        </video>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full px-4 text-center">
        ...
        <div className="mb-6 animate-fade-in-up">
          <div className="inline-flex items-center gap-3 px-5 py-2 border border-gold/40 bg-black/40 backdrop-blur-sm">
            <div className="grid size-8 place-items-center border border-gold text-gold bg-gold/10 font-serif text-sm">04</div>
            <span className="font-mono text-[10px] uppercase tracking-[0.4em] text-gold">Arc Four</span>
          </div>
        </div>
        ...
        <h1 className="animate-fade-in-up font-serif text-5xl sm:text-6xl md:text-7xl lg:text-8xl uppercase leading-none tracking-[0.02em] text-white drop-shadow-[0_0_30px_rgba(0,0,0,0.9)]" style={{ animationDelay: '0.2s' }}>
          The <span className="normal-case italic text-gold text-shimmer">Ascension</span>
        </h1>
...
function AudioControls() {
  ...
  React.useEffect(() => {
    audioRef.current = new Audio('/audio/ascension-ambient.mp3')
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-10">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <h2 className="font-serif text-2xl sm:text-3xl md:text-4xl uppercase tracking-[0.08em] text-white/90">
            Destroy <span className="italic text-gold">To Become</span>
          </h2>
        </div>

        <div className="space-y-8">
          <div className="animate-fade-in-up border-l-2 border-gold/30 pl-6 sm:pl-8" style={{ animationDelay: '0.0s' }}>
            <p className="text-sm sm:text-base leading-[1.9] text-white/70 font-light">The rapid rise of TRANSFINITY eventually triggered resistance from "The Frame." Governments, corporations, and powerful figures who controlled society began targeting the movement, labeling it as dangerous and unstable. Hidden Founder groups were hunted down, underground meeting places were destroyed, and many followers abandoned the symbol out of fear. For the first time since the awakening, the movement began collapsing from within. Betrayal spread through the inner circle, trust disappeared, and the world believed TRANSFINITY was finally dying. Amid the chaos, Kairos vanished once again, leaving the remaining Founders lost in darkness and uncertainty. This period became known as the Rebirth Arc — "Destroy To Become."</p>
          </div>
          <div className="animate-fade-in-up border-l-2 border-white/10 pl-6 sm:pl-8" style={{ animationDelay: '0.15s' }}>
            <p className="text-sm sm:text-base leading-[1.9] text-white/70 font-light">But destruction was never the end — it was transformation. While the world celebrated the fall of TRANSFINITY, Kairos isolated himself deep within the ruins beyond the city, rebuilding both his body and mind through pain, discipline, and silence. The old version of him no longer existed. Weeks turned into months, and rumors began spreading about a shadow-like figure appearing during storms, marked with glowing gold eyes and a darker infinity symbol. The movement slowly realized that Kairos had not disappeared to escape defeat — he disappeared to evolve into something stronger than before. The Rebirth Arc became the turning point where TRANSFINITY stopped being just a rebellion and started becoming a force powerful enough to challenge the world itself.</p>
          </div>
          ...
          <div className="animate-fade-in-up my-10 sm:my-12 py-8 px-6 sm:px-8 border border-gold/20 bg-gold/[0.03] text-center" style={{ animationDelay: '0.3s' }}>
            <div className="font-serif text-xl sm:text-2xl md:text-3xl italic text-gold/80 leading-relaxed">
              What does not destroy me makes me infinite.
            </div>
          </div>
        </div>
    ...
    <section className="relative z-10 py-16 sm:py-20 lg:py-24 pb-24 sm:pb-32">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-10">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <h2 className="font-serif text-2xl sm:text-3xl md:text-4xl uppercase tracking-[0.08em] text-white/90">
            Ascension <span className="italic text-gold">Essentials</span>
          </h2>
          <p className="mt-4 text-sm text-white/50 max-w-lg mx-auto">
            Rise from the ashes. Forged in fire, built for transcendence.
          </p>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          {ASCENSION_PRODUCTS.map((product, index) => (
        ...
        <div className="text-center mt-12 sm:mt-16 flex flex-wrap items-center justify-center gap-4">
          ...
          <Link to="/arcs/phantom" className="inline-flex items-center gap-2 px-6 py-3 border border-white/10 text-white/50 font-mono text-[10px] uppercase tracking-[0.3em] hover:border-gold/40 hover:text-gold transition-all duration-300">
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" /></svg>
            Previous Arc
          </Link>
          <Link to="/arcs/rebirth" className="inline-flex items-center gap-2 px-6 py-3 border border-gold/40 text-gold font-mono text-[10px] uppercase tracking-[0.3em] hover:bg-gold/10 transition-all duration-300">
            Next Arc
    ...
    <div className="group relative border border-white/10 bg-black/40 backdrop-blur-sm overflow-hidden transition-all duration-500 hover:border-gold/40 hover:bg-black/60 hover:-translate-y-2" style={{ animationDelay: `${index*0.1}s` }}>
      ...
      <div className="p-4 sm:p-5">
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="font-mono text-[10px] uppercase tracking-wider text-white/30">Arc 04</span>
        </div>
      </div>
    </div>
  )
