...
const REBIRTH_PRODUCTS = [
  { id: 'rebirth1', name: 'Rebirth Tee', price: 1299, image: '/products/rebirth-tee.jpg', description: 'Arc 05 exclusive. Limited edition.' },
  { id: 'rebirth2', name: 'Rebirth Hoodie', price: 2499, image: '/products/rebirth-hoodie.jpg', description: 'Premium streetwear for the journey.' },
  { id: 'rebirth3', name: 'Rebirth Cap', price: 899, image: '/products/rebirth-cap.jpg', description: 'Mark your path beyond limits.' },
  { id: 'rebirth4', name: 'Rebirth Poster', price: 599, image: '/products/rebirth-poster.jpg', description: 'Visual reminder of the threshold.' },
]
  ...
  return (
    <section className="relative w-full h-[70vh] sm:h-[80vh] overflow-hidden">
      <div className="absolute inset-0 z-0">
        <video autoPlay muted loop playsInline className="w-full h-full object-cover" poster="/videos/rebirth-poster.jpg">
          <source src="/videos/rebirth-header.mp4" type="video/mp4" />
        </video>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full px-4 text-center">
        ...
        <div className="mb-6 animate-fade-in-up">
          <div className="inline-flex items-center gap-3 px-5 py-2 border border-gold/40 bg-black/40 backdrop-blur-sm">
            <div className="grid size-8 place-items-center border border-gold text-gold bg-gold/10 font-serif text-sm">05</div>
            <span className="font-mono text-[10px] uppercase tracking-[0.4em] text-gold">Arc Five</span>
          </div>
        </div>
        ...
        <h1 className="animate-fade-in-up font-serif text-5xl sm:text-6xl md:text-7xl lg:text-8xl uppercase leading-none tracking-[0.02em] text-white drop-shadow-[0_0_30px_rgba(0,0,0,0.9)]" style={{ animationDelay: '0.2s' }}>
          The <span className="normal-case italic text-gold text-shimmer">Rebirth</span>
        </h1>
...
function AudioControls() {
  ...
  React.useEffect(() => {
    audioRef.current = new Audio('/audio/rebirth-ambient.mp3')
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-10">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <h2 className="font-serif text-2xl sm:text-3xl md:text-4xl uppercase tracking-[0.08em] text-white/90">
            Power In <span className="italic text-gold">Darkness</span>
          </h2>
        </div>

        <div className="space-y-8">
          <div className="animate-fade-in-up border-l-2 border-gold/30 pl-6 sm:pl-8" style={{ animationDelay: '0.0s' }}>
            <p className="text-sm sm:text-base leading-[1.9] text-white/70 font-light">The world changed the night Kairos returned. After months of silence and rumors, a massive blackout consumed the city, covering the skyline in darkness as the infinity symbol suddenly illuminated buildings, screens, and streets in glowing gold. From the shadows emerged a new version of Kairos — colder, stronger, and no longer hiding from the world. The people who once doubted TRANSFINITY now witnessed its true power for the first time. This event became known as the Eclipse Arc — "Power In Darkness." Unlike the earlier movement built on hope and awakening, the Eclipse Arc was built on dominance. TRANSFINITY was no longer asking humanity to evolve — it was forcing the world to confront its limits.</p>
          </div>
          <div className="animate-fade-in-up border-l-2 border-white/10 pl-6 sm:pl-8" style={{ animationDelay: '0.15s' }}>
            <p className="text-sm sm:text-base leading-[1.9] text-white/70 font-light">As chaos spread across society, hidden Founder factions reunited under Kairos once again, now wearing darker forms of the infinity emblem symbolizing rebirth through suffering. The Eclipse generation became feared throughout the underground because they no longer feared pain, isolation, or loss. They believed darkness was not something to escape, but something to master. Meanwhile, "The Frame" realized too late that suppressing TRANSFINITY had only made it stronger. Across cities around the world, people began abandoning the old system and following the movement openly, causing the balance of power to collapse. And standing at the center of it all was Kairos, whose presence now felt less human and more like the beginning of an unstoppable legend.</p>
          </div>
          ...
          <div className="animate-fade-in-up my-10 sm:my-12 py-8 px-6 sm:px-8 border border-gold/20 bg-gold/[0.03] text-center" style={{ animationDelay: '0.3s' }}>
            <div className="font-serif text-xl sm:text-2xl md:text-3xl italic text-gold/80 leading-relaxed">
              In darkness, we find the strength they tried to bury.
            </div>
          </div>
        </div>
    ...
    <section className="relative z-10 py-16 sm:py-20 lg:py-24 pb-24 sm:pb-32">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-10">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <h2 className="font-serif text-2xl sm:text-3xl md:text-4xl uppercase tracking-[0.08em] text-white/90">
            Rebirth <span className="italic text-gold">Essentials</span>
          </h2>
          <p className="mt-4 text-sm text-white/50 max-w-lg mx-auto">
            Born from the void. Darkness is not absence — it is potential.
          </p>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          {REBIRTH_PRODUCTS.map((product, index) => (
        ...
        <div className="text-center mt-12 sm:mt-16 flex flex-wrap items-center justify-center gap-4">
          ...
          <Link to="/arcs/ascension" className="inline-flex items-center gap-2 px-6 py-3 border border-white/10 text-white/50 font-mono text-[10px] uppercase tracking-[0.3em] hover:border-gold/40 hover:text-gold transition-all duration-300">
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" /></svg>
            Previous Arc
          </Link>
          <Link to="/arcs/eclipse-sun" className="inline-flex items-center gap-2 px-6 py-3 border border-gold/40 text-gold font-mono text-[10px] uppercase tracking-[0.3em] hover:bg-gold/10 transition-all duration-300">
            Next Arc
    ...
    <div className="group relative border border-white/10 bg-black/40 backdrop-blur-sm overflow-hidden transition-all duration-500 hover:border-gold/40 hover:bg-black/60 hover:-translate-y-2" style={{ animationDelay: `${index*0.1}s` }}>
      ...
      <div className="p-4 sm:p-5">
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="font-mono text-[10px] uppercase tracking-wider text-white/30">Arc 05</span>
        </div>
      </div>
    </div>
  )
