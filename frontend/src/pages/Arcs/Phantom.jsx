...
const PHANTOM_PRODUCTS = [
  { id: 'phantom1', name: 'Phantom Tee', price: 1299, image: '/products/phantom-tee.jpg', description: 'Arc 03 exclusive. Limited edition.' },
  { id: 'phantom2', name: 'Phantom Hoodie', price: 2499, image: '/products/phantom-hoodie.jpg', description: 'Premium streetwear for the journey.' },
  { id: 'phantom3', name: 'Phantom Cap', price: 899, image: '/products/phantom-cap.jpg', description: 'Mark your path beyond limits.' },
  { id: 'phantom4', name: 'Phantom Poster', price: 599, image: '/products/phantom-poster.jpg', description: 'Visual reminder of the threshold.' },
]
  ...
  return (
    <section className="relative w-full h-[70vh] sm:h-[80vh] overflow-hidden">
      <div className="absolute inset-0 z-0">
        <video autoPlay muted loop playsInline className="w-full h-full object-cover" poster="/videos/phantom-poster.jpg">
          <source src="/videos/phantom-header.mp4" type="video/mp4" />
        </video>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full px-4 text-center">
        ...
        <div className="mb-6 animate-fade-in-up">
          <div className="inline-flex items-center gap-3 px-5 py-2 border border-gold/40 bg-black/40 backdrop-blur-sm">
            <div className="grid size-8 place-items-center border border-gold text-gold bg-gold/10 font-serif text-sm">03</div>
            <span className="font-mono text-[10px] uppercase tracking-[0.4em] text-gold">Arc Three</span>
          </div>
        </div>
        ...
        <h1 className="animate-fade-in-up font-serif text-5xl sm:text-6xl md:text-7xl lg:text-8xl uppercase leading-none tracking-[0.02em] text-white drop-shadow-[0_0_30px_rgba(0,0,0,0.9)]" style={{ animationDelay: '0.2s' }}>
          The <span className="normal-case italic text-gold text-shimmer">Phantom</span>
        </h1>
...
function AudioControls() {
  ...
  React.useEffect(() => {
    audioRef.current = new Audio('/audio/phantom-ambient.mp3')
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-10">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <h2 className="font-serif text-2xl sm:text-3xl md:text-4xl uppercase tracking-[0.08em] text-white/90">
            The Rise <span className="italic text-gold">Beyond Limits</span>
          </h2>
        </div>

        <div className="space-y-8">
          <div className="animate-fade-in-up border-l-2 border-gold/30 pl-6 sm:pl-8" style={{ animationDelay: '0.0s' }}>
            <p className="text-sm sm:text-base leading-[1.9] text-white/70 font-light">The disappearance of Kairos created something unexpected — evolution. What began as whispers in hidden alleyways slowly became a global underground movement. Across different cities, people wearing the infinity symbol started rejecting "The Frame" and pursuing their own paths beyond fear and limitation. The mysterious followers known as the Founders began building hidden networks, spreading encrypted messages, designs, and philosophies connected to TRANSFINITY. As the movement expanded, society started realizing that this was no longer just rebellion — it was the beginning of a new era. This period became known as the Ascension Arc — "Rise Beyond Limits."</p>
          </div>
          <div className="animate-fade-in-up border-l-2 border-white/10 pl-6 sm:pl-8" style={{ animationDelay: '0.15s' }}>
            <p className="text-sm sm:text-base leading-[1.9] text-white/70 font-light">During the Ascension Arc, individuals who once felt powerless started transforming themselves mentally, physically, and creatively. The infinity symbol evolved into a mark of progression, worn only by those willing to sacrifice comfort in order to evolve. Luxury streetwear inspired by TRANSFINITY began appearing across the underground scene, carrying hidden meanings connected to growth and awakening. But while the movement was rising, powerful forces inside "The Frame" began seeing TRANSFINITY as a threat to their control. And deep within the shadows, Kairos finally returned for the first time since his disappearance — not as a creator, but as the leader of an unstoppable evolution.</p>
          </div>
          ...
          <div className="animate-fade-in-up my-10 sm:my-12 py-8 px-6 sm:px-8 border border-gold/20 bg-gold/[0.03] text-center" style={{ animationDelay: '0.3s' }}>
            <div className="font-serif text-xl sm:text-2xl md:text-3xl italic text-gold/80 leading-relaxed">
              Evolution demands sacrifice. Comfort is the enemy of growth.
            </div>
          </div>
        </div>
    ...
    <section className="relative z-10 py-16 sm:py-20 lg:py-24 pb-24 sm:pb-32">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-10">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <h2 className="font-serif text-2xl sm:text-3xl md:text-4xl uppercase tracking-[0.08em] text-white/90">
            Phantom <span className="italic text-gold">Essentials</span>
          </h2>
          <p className="mt-4 text-sm text-white/50 max-w-lg mx-auto">
            Embrace the phantom within. For those who move in silence and strike with purpose.
          </p>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          {PHANTOM_PRODUCTS.map((product, index) => (
        ...
        <div className="text-center mt-12 sm:mt-16 flex flex-wrap items-center justify-center gap-4">
          ...
          <Link to="/arcs/founderer" className="inline-flex items-center gap-2 px-6 py-3 border border-white/10 text-white/50 font-mono text-[10px] uppercase tracking-[0.3em] hover:border-gold/40 hover:text-gold transition-all duration-300">
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" /></svg>
            Previous Arc
          </Link>
          <Link to="/arcs/ascension" className="inline-flex items-center gap-2 px-6 py-3 border border-gold/40 text-gold font-mono text-[10px] uppercase tracking-[0.3em] hover:bg-gold/10 transition-all duration-300">
            Next Arc
    ...
    <div className="group relative border border-white/10 bg-black/40 backdrop-blur-sm overflow-hidden transition-all duration-500 hover:border-gold/40 hover:bg-black/60 hover:-translate-y-2" style={{ animationDelay: `${index*0.1}s` }}>
      ...
      <div className="p-4 sm:p-5">
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="font-mono text-[10px] uppercase tracking-wider text-white/30">Arc 03</span>
        </div>
      </div>
    </div>
  )
