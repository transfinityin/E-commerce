...
const ECLIPSESUN_PRODUCTS = [
  { id: 'eclipse-sun1', name: 'EclipseSun Tee', price: 1299, image: '/products/eclipse-sun-tee.jpg', description: 'Arc 06 exclusive. Limited edition.' },
  { id: 'eclipse-sun2', name: 'EclipseSun Hoodie', price: 2499, image: '/products/eclipse-sun-hoodie.jpg', description: 'Premium streetwear for the journey.' },
  { id: 'eclipse-sun3', name: 'EclipseSun Cap', price: 899, image: '/products/eclipse-sun-cap.jpg', description: 'Mark your path beyond limits.' },
  { id: 'eclipse-sun4', name: 'EclipseSun Poster', price: 599, image: '/products/eclipse-sun-poster.jpg', description: 'Visual reminder of the threshold.' },
]

export default function EclipseSun() {
  return (
    <>
      <style>{`
        @keyframes fadeInUp {
  ...
  return (
    <section className="relative w-full h-[70vh] sm:h-[80vh] overflow-hidden">
      <div className="absolute inset-0 z-0">
        <video autoPlay muted loop playsInline className="w-full h-full object-cover" poster="/videos/eclipse-sun-poster.jpg">
          <source src="/videos/eclipse-sun-header.mp4" type="video/mp4" />
        </video>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full px-4 text-center">
        ...
        <div className="mb-6 animate-fade-in-up">
          <div className="inline-flex items-center gap-3 px-5 py-2 border border-gold/40 bg-black/40 backdrop-blur-sm">
            <div className="grid size-8 place-items-center border border-gold text-gold bg-gold/10 font-serif text-sm">06</div>
            <span className="font-mono text-[10px] uppercase tracking-[0.4em] text-gold">Arc Six</span>
          </div>
        </div>
        ...
        <h1 className="animate-fade-in-up font-serif text-5xl sm:text-6xl md:text-7xl lg:text-8xl uppercase leading-none tracking-[0.02em] text-white drop-shadow-[0_0_30px_rgba(0,0,0,0.9)]" style={{ animationDelay: '0.2s' }}>
          The <span className="normal-case italic text-gold text-shimmer">EclipseSun</span>
        </h1>
...
function AudioControls() {
  ...
  React.useEffect(() => {
    audioRef.current = new Audio('/audio/eclipse-sun-ambient.mp3')
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-10">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <h2 className="font-serif text-2xl sm:text-3xl md:text-4xl uppercase tracking-[0.08em] text-white/90">
            The Blood <span className="italic text-gold">Oath</span>
          </h2>
        </div>

        <div className="space-y-8">
          <div className="animate-fade-in-up border-l-2 border-gold/30 pl-6 sm:pl-8" style={{ animationDelay: '0.0s' }}>
            <p className="text-sm sm:text-base leading-[1.9] text-white/70 font-light">After the rise of the Eclipse generation, TRANSFINITY was no longer just a hidden movement — it had become an empire growing beneath the surface of society. Those who survived the darkness of the previous arcs formed an elite inner circle known as The Crimson Order, warriors bound not by fear or power, but by loyalty to the infinite vision created by Kairos. Each member carried a crimson-marked infinity symbol representing a blood oath: once accepted into the order, betrayal was impossible. This era became known as the Crimson Arc — "The Blood Oath." The streets transformed into battlegrounds between loyalists of TRANSFINITY and forces still trying to protect "The Frame." But unlike before, the Founders were now united, disciplined, and willing to sacrifice everything for the movement.</p>
          </div>
          <div className="animate-fade-in-up border-l-2 border-white/10 pl-6 sm:pl-8" style={{ animationDelay: '0.15s' }}>
            <p className="text-sm sm:text-base leading-[1.9] text-white/70 font-light">During the Crimson Arc, Kairos began preparing humanity for something greater than rebellion — transcendence itself. Hidden sanctuaries known as "Infinite Chambers" were built beneath cities where selected followers trained their minds and bodies beyond normal human limits. The Crimson generation believed evolution required sacrifice, and only those who endured suffering deserved to carry the symbol. As their influence spread globally, stories emerged of Founder squads appearing during moments of chaos, protecting people from corruption before disappearing back into the shadows. To the public, they became myths. To TRANSFINITY, they became the first true guardians of the infinite path. But unknown to everyone, Kairos had already begun hearing whispers from a mysterious dimension beyond reality itself — a place later known as The Void.</p>
          </div>
    ...
    <section className="relative z-10 py-16 sm:py-20 lg:py-24 pb-24 sm:pb-32">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-10">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <h2 className="font-serif text-2xl sm:text-3xl md:text-4xl uppercase tracking-[0.08em] text-white/90">
            EclipseSun <span className="italic text-gold">Essentials</span>
          </h2>
          <p className="mt-4 text-sm text-white/50 max-w-lg mx-auto">
            Sworn in crimson. For the loyal, the fearless, the eternal.
          </p>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          {ECLIPSESUN_PRODUCTS.map((product, index) => (
        ...
        <div className="text-center mt-12 sm:mt-16 flex flex-wrap items-center justify-center gap-4">
          ...
          <Link to="/arcs/rebirth" className="inline-flex items-center gap-2 px-6 py-3 border border-white/10 text-white/50 font-mono text-[10px] uppercase tracking-[0.3em] hover:border-gold/40 hover:text-gold transition-all duration-300">
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" /></svg>
            Previous Arc
          </Link>
          <Link to="/arcs/crimson" className="inline-flex items-center gap-2 px-6 py-3 border border-gold/40 text-gold font-mono text-[10px] uppercase tracking-[0.3em] hover:bg-gold/10 transition-all duration-300">
            Next Arc
    ...
    <div className="group relative border border-white/10 bg-black/40 backdrop-blur-sm overflow-hidden transition-all duration-500 hover:border-gold/40 hover:bg-black/60 hover:-translate-y-2" style={{ animationDelay: `${index*0.1}s` }}>
      ...
      <div className="p-4 sm:p-5">
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="font-mono text-[10px] uppercase tracking-wider text-white/30">Arc 06</span>
        </div>
      </div>
    </div>
  )
