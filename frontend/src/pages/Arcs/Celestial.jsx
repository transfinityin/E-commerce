...
const CELESTIAL_PRODUCTS = [
  { id: 'celestial1', name: 'Celestial Tee', price: 1299, image: '/products/celestial-tee.jpg', description: 'Arc 12 exclusive. Limited edition.' },
  { id: 'celestial2', name: 'Celestial Hoodie', price: 2499, image: '/products/celestial-hoodie.jpg', description: 'Premium streetwear for the journey.' },
  { id: 'celestial3', name: 'Celestial Cap', price: 899, image: '/products/celestial-cap.jpg', description: 'Mark your path beyond limits.' },
  { id: 'celestial4', name: 'Celestial Poster', price: 599, image: '/products/celestial-poster.jpg', description: 'Visual reminder of the threshold.' },
]
  ...
  return (
    <section className="relative w-full h-[70vh] sm:h-[80vh] overflow-hidden">
      <div className="absolute inset-0 z-0">
        <video autoPlay muted loop playsInline className="w-full h-full object-cover" poster="/videos/celestial-poster.jpg">
          <source src="/videos/celestial-header.mp4" type="video/mp4" />
        </video>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full px-4 text-center">
        ...
        <div className="mb-6 animate-fade-in-up">
          <div className="inline-flex items-center gap-3 px-5 py-2 border border-gold/40 bg-black/40 backdrop-blur-sm">
            <div className="grid size-8 place-items-center border border-gold text-gold bg-gold/10 font-serif text-sm">12</div>
            <span className="font-mono text-[10px] uppercase tracking-[0.4em] text-gold">Arc Twelve</span>
          </div>
        </div>
        ...
        <h1 className="animate-fade-in-up font-serif text-5xl sm:text-6xl md:text-7xl lg:text-8xl uppercase leading-none tracking-[0.02em] text-white drop-shadow-[0_0_30px_rgba(0,0,0,0.9)]" style={{ animationDelay: '0.2s' }}>
          The <span className="normal-case italic text-gold text-shimmer">Celestial</span>
        </h1>
...
function AudioControls() {
  ...
  React.useEffect(() => {
    audioRef.current = new Audio('/audio/celestial-ambient.mp3')
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-10">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <h2 className="font-serif text-2xl sm:text-3xl md:text-4xl uppercase tracking-[0.08em] text-white/90">
            Legacy <span className="italic text-gold">Never Dies</span>
          </h2>
        </div>

        <div className="space-y-8">
          <div className="animate-fade-in-up border-l-2 border-gold/30 pl-6 sm:pl-8" style={{ animationDelay: '0.0s' }}>
            <p className="text-sm sm:text-base leading-[1.9] text-white/70 font-light">Centuries after the Celestial Arc, the world was no longer recognizable as the broken society once controlled by "The Frame." Nations had transformed into vast luminous cities connected through the philosophy of infinite evolution, and the infinity symbol became more than a mark — it became the universal emblem of humanity itself. This final era became known as the Eternal Arc — "Legacy Never Dies." The Founders who survived the Shadow War were remembered not as warriors, but as legends who guided humanity into a new age beyond fear, greed, and limitation. Stories about Kairos spread across generations like mythology, yet nobody truly knew whether he had died, ascended, or become something beyond existence entirely.</p>
          </div>
          <div className="animate-fade-in-up border-l-2 border-white/10 pl-6 sm:pl-8" style={{ animationDelay: '0.15s' }}>
            <p className="text-sm sm:text-base leading-[1.9] text-white/70 font-light">But deep within the Infinite Dimension, beyond time and reality, the consciousness of Kairos still remained. Watching silently from the spaces between dimensions, he smiled. TRANSFINITY had succeeded. Humanity had learned to evolve without limits, to question without fear, and to dream without boundaries. The Frame had been destroyed not by war, but by the awakening of human potential itself. And somewhere in the eternal darkness, a new infinity symbol began forming — not drawn by hands, but born from the universe itself. Because TRANSFINITY was never just a movement. It was the beginning of something that would never end.</p>
          </div>
          ...
          <div className="animate-fade-in-up my-10 sm:my-12 py-8 px-6 sm:px-8 border border-gold/20 bg-gold/[0.03] text-center" style={{ animationDelay: '0.3s' }}>
            <div className="font-serif text-xl sm:text-2xl md:text-3xl italic text-gold/80 leading-relaxed">
              Infinity does not end. It simply begins again.
            </div>
          </div>
        </div>
    ...
    <section className="relative z-10 py-16 sm:py-20 lg:py-24 pb-24 sm:pb-32">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-10">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <h2 className="font-serif text-2xl sm:text-3xl md:text-4xl uppercase tracking-[0.08em] text-white/90">
            Celestial <span className="italic text-gold">Essentials</span>
          </h2>
          <p className="mt-4 text-sm text-white/50 max-w-lg mx-auto">
            Timeless. Eternal. The final mark of infinity.
          </p>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          {CELESTIAL_PRODUCTS.map((product, index) => (
        ...
        <div className="text-center mt-12 sm:mt-16 flex flex-wrap items-center justify-center gap-4">
          ...
          <Link to="/arcs/shadow-war" className="inline-flex items-center gap-2 px-6 py-3 border border-white/10 text-white/50 font-mono text-[10px] uppercase tracking-[0.3em] hover:border-gold/40 hover:text-gold transition-all duration-300">
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" /></svg>
            Previous Arc
          </Link>
    ...
    <div className="group relative border border-white/10 bg-black/40 backdrop-blur-sm overflow-hidden transition-all duration-500 hover:border-gold/40 hover:bg-black/60 hover:-translate-y-2" style={{ animationDelay: `${index*0.1}s` }}>
      ...
      <div className="p-4 sm:p-5">
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="font-mono text-[10px] uppercase tracking-wider text-white/30">Arc 12</span>
        </div>
      </div>
    </div>
  )
