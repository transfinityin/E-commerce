    ...
    <div className="grid min-h-[calc(100vh-136px)] lg:grid-cols-2">
      ...
      <div className="hidden lg:flex relative flex-col justify-center items-start overflow-hidden bg-[var(--color-secondary)] text-white px-14 py-16">
        ...
        <div className="relative z-10 w-full max-w-md">
          ...
          <h2 className="font-[Playfair_Display] text-4xl md:text-5xl font-bold text-white leading-tight mb-5">
            Welcome<br />
          ...
          {/* Testimonial Card */}
          <div className="bg-white/5 border border-white/[0.08] rounded-2xl mt-14 p-6">
      ...
      <div className="flex flex-col justify-center items-center bg-[var(--color-bg)] px-6 py-12 lg:px-10">
        ...
        <div className="w-full max-w-md animate-fadeUp">
          ...
          <p className="text-sm text-[var(--color-muted)] mb-9">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-2">
              <div className="flex justify-between items-center">
                ...
                <Link to="/forgot-password" className="text-xs text-[var(--color-muted)] no-underline hover:text-[var(--color-text)] transition-colors">
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className={`w-full bg-[var(--color-surface)] border-[1.5px] border-[var(--color-border)] rounded-xl text-sm text-[var(--color-text)] transition-all duration-300 focus:border-[var(--color-text)] focus:shadow-[0_0_0_3px_rgba(13,13,13,0.06)] outline-none pl-11 pr-11 h-12 placeholder:text-[var(--color-muted-light)] ${errors.password ? '!border-[var(--color-danger)]' : ''}`}
                />
                <button
                  type="button"
